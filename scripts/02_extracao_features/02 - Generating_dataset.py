...
if __name__ == '__main__':
    ...
    pcapfiles = ['capture.pcap'] #Place your pcap files here.
    subfiles_size = 1 # MB
    split_directory = '/tmp/split/'
    ...
    for i in range(len(pcapfiles)):
        ...
        os.system(f'tcpdump -r {pcap_file} -w {split_directory}split_temp.pcap -C {subfiles_size}')
